...
로직 없음: Mustache는 if/else, for 루프 같은 로직이 없습니다. 데이터를 미리 준비해야 합니다.
스페이스 민감: {{#section}}과 {{/section}} 사이의 들여쓰기와 공백이 그대로 유지됩니다.
변수명 규칙:
...
HTML 이스케이프: 기본적으로 HTML 특수문자(<, >, & 등)가 자동으로 이스케이프됩니다.
...
- 
- 
1. **HTML 이스케이프**: 기본적으로 HTML 특수문자(`<`, `>`, `&` 등)가 자동으로 이스케이프됩니다.
- [Mustache 공식 문서](%5Bhttps://mustache.github.io/%5D(https://mustache.github.io/))
- [Mustache Manual](%5Bhttps://mustache.github.io/mustache.5.html%5D(https://mustache.github.io/mustache.5.html))